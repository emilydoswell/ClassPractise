...
public class EmployeePresentationImpl implements EmployeePresentation {
    ...
    public void showMenu() {
        ...
        System.out.println("7. List Employees by department");
    ...
    public void performMenu(int choice) {
        ...
        switch (choice) {
            ...
            case 7:
                ...
                List<Employee> employeesDept = employeeService.searchEmployeeByDepartment(employeeDept);
                if (employeesDept != null) {
                    for (Employee emp : employeesDept) {
                        System.out.println(emp);
                    }
                } else {
                    System.out.println("No employees found in department " + employeeDept);
                }
                break;
            case 8:
